        ...
        <Section background="dark">
            <div className="flex flex-col gap-12">
                <div className="max-w-3xl">
                    <span className="text-xs font-bold text-[#10b981] tracking-widest uppercase mb-3 block">WHY XSAI</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
                    {reasons.map((reason, index) => (
                        <div key={index} className="flex items-center gap-4">
                            ...
                            <span className="text-white text-lg font-medium">{reason}</span>
                        </div>
                    ))}
                </div>

                <div className="text-center pt-8 border-t border-gray-800 mt-8">
                    <p className="text-[#d1fae5] italic text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                        "We are not a volume call centre. We build stable relationships with businesses that value structure and fairness."
                    </p>
                </div>
            </div>
        </Section>
