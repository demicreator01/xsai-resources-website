...
export const Button: React.FC<ButtonProps> = ({
    ...
    const variants = {
        primary: "bg-green-primary text-white hover:bg-green-dark shadow-sm hover:translate-y-[-1px]",
        secondary: "border-2 border-green-primary text-green-primary bg-transparent hover:bg-[#d1fae5]",
        ...
        white: "bg-white text-green-dark hover:bg-gray-100 shadow-sm"
    };
