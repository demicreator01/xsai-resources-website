            ...
            <div className="relative z-10 max-w-[760px] mx-auto text-center">
                ...
                <div className="fade-up mb-8 md:mb-10">
                    ...
                    <h2 className="text-[1.9rem] md:text-[2.6rem] font-bold text-white leading-[1.1] tracking-tight mb-6">
                        Why This Model{' '}
                        <span className="text-green-primary">Works</span>
                    </h2>
                    <div className="space-y-3 text-[1.05rem] text-text-muted leading-relaxed max-w-[540px] mx-auto">
                        <p>
                ...
                <div className="fade-up mb-10 md:mb-12 flex flex-col gap-0" style={{ animationDelay: '100ms' }}>
                    ...
                    <div className="flex flex-col gap-5">
                        {noStatements.map((item, i) => (
                            <div
                                key={i}
                                className="group flex flex-col items-center gap-1.5 py-5 border-b border-white/8 last:border-0 hover:bg-white/[0.02] rounded-xl transition-colors duration-200 px-4"
                            >
                ...
                <div className="fade-up" style={{ animationDelay: '180ms' }}>
                    <p className="text-[1.1rem] md:text-[1.3rem] font-bold text-text-muted mb-2">
                        Just structured operations
                    </p>
                    <p className="text-[1.4rem] md:text-[1.8rem] font-bold text-green-primary leading-snug">
                        and shared benefit.
                    </p>
                </div>
